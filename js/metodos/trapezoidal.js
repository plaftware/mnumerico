...
metodo.run = function() {
    ...
    for (let i = 1; i < Number(app.n); i++) {
        ecuacion = funX(`2[${funcion}]`, x1 + app.delta);
    ...
    app.resultado = `Resultado: (${app.b - app.a}[${resultadoTotal}]/${app.n * 2}) = ${((app.b - app.a)*resultadoTotal)/(app.n * 2)}`;
}

app.metodos['05'] = metodo;